...
const Menu = ({ isActive, setIsActive }) => {
  ...
  return (
    <div className="relative">
      <motion.div
        className="menu-dialog w-[350px] h-[500px] bg-purple-900 dark:bg-yellow-300 rounded-2xl relative flex items-center pl-4"
        variants={variants}
      ...
      <div className="overflow-hidden absolute top-0 right-0">
        ...
        >
          <div className="primary-rubik w-[100px] cursor-pointer rounded-full bg-purple-900 dark:bg-yellow-300 text-white dark:text-black px-4 py-2 text-center">
            <p>MENU</p>
          </div>
